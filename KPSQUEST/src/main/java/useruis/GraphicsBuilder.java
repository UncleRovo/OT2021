...
public class GraphicsBuilder {
    ...
    /**
    * Metodilla voi pienentää (taikka suurentaa) ImageView-oliota
    * tarvittaessa, hyödyllinen mikäli piirretty grafiikka osoittautuu
    * väärän kokoiseksi.
    *
    ...
    */
    ...
    /**
    * Metodilla voi tehdä Polygon-olion, joka toimii esimerkiksi
    * törmäysten tarkastelussa tai puhekuplana.
    *
